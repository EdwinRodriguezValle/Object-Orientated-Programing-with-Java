...
public class BedrijfLauncher {
    public static void main(String[] args) {
       ...
       // Werknemer werknemer = new Werknemer("Edwin", "Ollantaytambo", new Afdeling("CEGIM", "Cusco"), -5000 );
        Scanner input = new Scanner(System.in);

        System.out.println("Geeft de naam:");
        String naam = input.nextLine();
        System.out.println("Geeft de woontplaats:");
        String woonplaats = input.nextLine();
        System.out.println("Geeft de naam van de afdeling:");
        String afdelingsNaam = input.nextLine();
        System.out.println("Geeft the afdelingsPlaast:");
        String afdelingsPlaats = input.nextLine();

        boolean ontjuisteInvoer = true;
        while (ontjuisteInvoer) {
            System.out.println("Geeft maandSalaris:");
            ...
            try {
                ...
                ontjuisteInvoer = false;
            } catch (IllegalArgumentException fout) {
                System.out.println(fout.getMessage());
            } finally {
                System.out.println("tu ingreso ha sido correctamente gestionado!");
            }
