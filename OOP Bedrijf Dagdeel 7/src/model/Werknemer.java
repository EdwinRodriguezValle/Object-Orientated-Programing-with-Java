...
public class Werknemer extends Persoon {
    ...
    public Werknemer(String naam, String woonplaats, Afdeling afdeling,
                     double maandSalaris) {
        super(naam, woonplaats, afdeling);
        this.setMaandSalaris(maandSalaris); // En este coso se ajusta para el this para evtar que aya confusión si hay más de un método que usa setMaandSalaris,
        // sino no hay problema y funciona normal.
